...
date: 2015-12-01 18:25:00 -0500 EST
categories: Software
---
...
Have you ever had a file named ``` ``` (that is, a single space)?  Or maybe ```-l```?  How would you ```ls``` that file if you didn't know ahead of time to expect it?  Would all your shell scripts handle them cleanly?  Do you even know which utilities would fail?  I don't.
...
Wow.  There is such a wide disparity between what filesystems *support* and what normal people *actually use*.  How did we get to here?

I'm usually on the "crazy" side of using *spaces* in filenames, but even I think it's wild to allow stuff like vertical tabs, or end-of-transmission.  At *least* it disallows null characters.
